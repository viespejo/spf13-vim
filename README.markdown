...
The easiest way to install spf13-vim is to use our [automatic installer](https://raw.github.com/viespejo/spf13-vim/nb/bootstrap.sh) by simply copying and pasting the following line into a terminal. This will install spf13-vim and backup your existing vim configuration. If you are upgrading from a prior version (before 3.0) this is also the recommended installation.

*Requires Git 1.7+ and Vim 7.3+*

```bash

    curl https://raw.github.com/viespejo/spf13-vim/nb/bootstrap.sh -L > bootstrap.sh && sh bootstrap.sh
```

If you have a bash-compatible shell you can run the script directly:
```bash

    sh <(curl https://raw.github.com/viespejo/spf13-vim/nb/bootstrap.sh -L)
```
...
```bash
    ...
    curl https://raw.github.com/viespejo/spf13-vim/nb/bootstrap.sh -L -o - | sh
